...
function Thoughts() {
  ...
  return (
    <div>
      {showaddthought && <AddThought onClosedialog={handleclose} topic={topicObject.title}/>}
      <div className="text-black text-2xl font-bold text-center my-8">
        {topicObject.title}
      </div>

      <div className="flex-col items-center text-center">
        {topicObject.thoughts.map((thought) => (
          <div className="bg-blue-200 pb-6 m-4 rounded-lg">
